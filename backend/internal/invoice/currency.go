...
func validateCurrency(currency string) bool {
	_, ok := validCurrencyCodes[currency]
	return ok
}

// validCurrencyCodes enthält die aktiven ISO-4217-Alpha-3-Währungscodes.
var validCurrencyCodes = map[string]struct{}{
	...
	"TZS": {}, "UAH": {}, "UGX": {}, "USD": {}, "USN": {}, "UYI": {}, "UYU": {}, "UYW": {},
	"UZS": {}, "VED": {}, "VES": {}, "VND": {}, "VUV": {}, "WST": {}, "XAF": {}, "XAG": {},
