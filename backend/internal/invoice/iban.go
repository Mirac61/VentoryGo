...
// validIbanLengths enthält die je Land vorgeschriebene IBAN-Länge gemäß IBAN-Registry.
var validIbanLengths = map[string]int{
...
func validateIban(iban string) bool {
	...
	countryCode := iban[:2]
	expectedLength, ok := validIbanLengths[countryCode]
